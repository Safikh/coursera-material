...
class LoadTest(HttpUser):
    ...
    def predict_batch_1(self):
        ...
        self.client.post(
            "http://batch-1:80/predict", json=request_body, name="batch_1"
        )
    ...
    def predict_batch_32(self):
        ...
        self.client.post(
            "http://batch-32:80/predict", json=request_body, name="batch_32"
        )
    ...
    def predict_batch_64(self):
        ...
        self.client.post(
            "http://batch-64:80/predict", json=request_body, name="batch_64"
        )
